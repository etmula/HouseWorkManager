...
urlpatterns = [
    ...
    path('group/invite/', views.GroupInviteView.as_view(), name='group_invite'),
    path('group/quit/confirm', views.GroupQuitConfirmView.as_view(), name='group_quit_confirm'),
    path('group/quit/done', views.GroupQuitDoneView.as_view(), name='group_quit_done'),
    ...
    path('group/join/accept', views.GroupJoinAcceptView.as_view(), name='group_join_accept'),
